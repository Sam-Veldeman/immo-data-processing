...
selected_values = [
    ...
    ("Location area", "property.location.type"),
    ...
    ("Total surface", "property.land.surface"),
    ...
    ("Terrace surface", "property.terraceSurface"),
    ("Garden", "property.hasGarden"),
    ("Garden surface", "property.gardenSurface"),
...
def get_urls(num_pages, session):
    ...
    for i in range(1, num_pages + 1):
        ...
        root_url = f"https://www.immoweb.be/nl/zoeken/appartement/te-koop?countries=BE&page={i}&orderBy=relevance"
